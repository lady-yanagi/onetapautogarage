        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT service_list.id,service_list.service, service_list.description, service_list.status, service_list.date_created
						FROM service_list
						INNER JOIN users ON service_list.brand=users.brand; ");
