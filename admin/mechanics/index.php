        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT mechanics_list.id,mechanics_list.name, mechanics_list.contact, mechanics_list.email, mechanics_list.status, mechanics_list.date_created
						FROM mechanics_list
