            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>Payment on Progress</option>
                        <option value="4" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>Cancelled</option>
                    </select>
                </div>
            </div>
        </div>
