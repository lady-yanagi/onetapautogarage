			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select">
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Garage Owner</option>
					</select>
				</div>
				<div class="form-group col-6">
					<label for="username">Brand</label>
					<input type="text" name="brand" id="brand" class="form-control" value="<?php echo isset($meta['brand']) ? $meta['brand']: '' ?>" required  autocomplete="off">
				</div>
				<div class="form-group col-6">
