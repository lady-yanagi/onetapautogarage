            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  ...
                  <?php 
                   $brand = $_settings->userdata('brand');
                    $inv = $conn->query("SELECT count(id) as total FROM categories where brand = '$brand'")->fetch_assoc()['total'];
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php 
                   $brand = $_settings->userdata('brand');
                    $inv = $conn->query("SELECT count(id) as total FROM mechanics_list where brand = '$brand'")->fetch_assoc()['total'];
                    echo number_format($inv);
                  ?>
                </span>
              </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php 
                   $brand = $_settings->userdata('brand');
                    $inv = $conn->query("SELECT count(id) as total FROM service_list where brand = '$brand'")->fetch_assoc()['total'];
                    echo number_format($inv);
                  ?>
                </span>
              </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php 
                   $brand = $_settings->userdata('brand');
                    $inv = $conn->query("SELECT count(id) as total FROM service_requests where brand = '$brand'")->fetch_assoc()['total'];
                    echo number_format($inv);
                  ?>
                </span>
              </div>
