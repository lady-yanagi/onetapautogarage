        ...
        <div id="printable">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                        $mechanic = $conn->query("SELECT mechanics_list.id,mechanics_list.name, mechanics_list.contact, mechanics_list.email, mechanics_list.status, mechanics_list.date_created
						FROM mechanics_list
						INNER JOIN users ON mechanics_list.brand=users.brand;");
